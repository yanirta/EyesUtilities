...
public class FailedStep {
    ...
    private String getAnimatedDiff(String expectedImageId, String actualImageId, boolean withDiff) throws IOException {
        if (outFolder == null)
    ...
    public String getAnimatedDiff() throws IOException {
        return getAnimatedDiff(expected.getImageId(), actual.getImageId(), true);
    }

    public String getAnimatedThumbprints() throws IOException {
        try {
            return getAnimatedDiff(expected.getThumbprintId(), actual.getThumbprintId(), false);
        }catch (Exception e){
